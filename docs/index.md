...
| Document                    | Purpose                                               |
| --------------------------- | ----------------------------------------------------- |
| architecture.md             | Defines the architectural layers and system structure |
| philosophy.md               | Defines Remin's guiding principles                    |
| domains.md                  | Defines the core business domains                     |
| glossary.md                 | Defines architectural terminology                     |
